pipeline {
  ...
  parameters {
        extendedChoice(name: 'Region_Action', description: 'Select an action for regions. Note: Choose "Delete a Region" only if Region already exists', type: 'PT_RADIO', value: 'Create a Region, Delete a Region')
